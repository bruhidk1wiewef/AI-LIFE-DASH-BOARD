...
export default function SignupPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(circle_at_80%_20%,rgba(167,139,250,0.15),transparent_50%)]" />
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-muted-foreground">Start managing your life with AI — free forever plan available</p>
        </div>
        ...
        <div className="glass-card p-7">
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="name" required value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Alex Morgan" />
            </div>
            <div className="space-y-1.5">
